...
<body>  
    <h1 class="container">FAKTUR_PENJUALAN</h1>

    <form action="prosesfaktur-p.php" method="POST" class="container">
       ...
       <div class="mb-3">
        <label for="" class="form-label">ID_PELANGGAN</label>
        <input type="text" name="ip" class="form-control" style="width: 400px;">     
     </div>
...
$nama=$_POST['cari'];    
include"koneksi.php";
$filter=mysqli_query($conn,"select * from faktu_penjualan where id_pelanggan like '%$nama%' order by id_pelanggan desc");
$no=1;
